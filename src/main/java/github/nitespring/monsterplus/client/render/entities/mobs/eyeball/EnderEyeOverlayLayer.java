...
public class EnderEyeOverlayLayer<T extends DemonEye> extends RenderLayer<T, DemonEyeModel<T>>{

	 private final DemonEyeModel<T> model;
	 //SlimeOuterLayer

	public EnderEyeOverlayLayer(RenderLayerParent<T, DemonEyeModel<T>> p_117346_, EntityModelSet p_174491_) {
		super(p_117346_);
	...
	public ResourceLocation getTextureLocation(T e) {
		...
		return EnderEyeRenderer.OVERLAY1;
	}
