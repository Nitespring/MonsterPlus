...
public class DesertAcolyeEmissiveLayer<T extends SpellcasterIllager> extends RenderLayer<T, DesertAcolyteModel<T>>{


	public static final ResourceLocation TEXTURE_LOCATION = ResourceLocation.fromNamespaceAndPath(MonsterPlus.MODID, "textures/entities/desert_acolyte_emissive.png");
	private final DesertAcolyteModel<T> model;

	public DesertAcolyeEmissiveLayer(RenderLayerParent<T, DesertAcolyteModel<T>> p_117346_, EntityModelSet p_174491_) {
		super(p_117346_);
		this.model = new DesertAcolyteModel<>(p_174491_.bakeLayer(ClientListener.DESERT_ACOLYTE));
	}
