...
public class DesertSorceressEmissiveLayer<T extends SpellcasterIllager> extends RenderLayer<T, DesertSorceressModel<T>>{


	public static final ResourceLocation TEXTURE_LOCATION = ResourceLocation.fromNamespaceAndPath(MonsterPlus.MODID, "textures/entities/desert_sorceress_emissive.png");
	private final DesertSorceressModel<T> model;

	public DesertSorceressEmissiveLayer(RenderLayerParent<T, DesertSorceressModel<T>> p_117346_, EntityModelSet p_174491_) {
		super(p_117346_);
		this.model = new DesertSorceressModel<>(p_174491_.bakeLayer(ClientListener.DESERT_SORCERESS));
	}
