...
public class WispOverlayLayer<T extends Wisp> extends RenderLayer<T, WispModel<T>>{

	 private final WispModel<T> model;
	 //SlimeOuterLayer

	public WispOverlayLayer(RenderLayerParent<T, WispModel<T>> p_117346_, EntityModelSet p_174491_) {
		super(p_117346_);
