package github.nitespring.monsterplus.client.render.particles;
...
public class CurseflameParticleProvider implements ParticleProvider<SimpleParticleType> {
    ...
    public Particle createParticle(SimpleParticleType type, ClientLevel level,
        ...
        return new CurseflameParticle(level, x, y, z, spriteSet);
    }
