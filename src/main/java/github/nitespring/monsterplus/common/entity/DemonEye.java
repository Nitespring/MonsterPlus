...
public class DemonEye extends FlyingMob implements Enemy{
   ...
   DemonEye.AttackPhase attackPhase = DemonEye.AttackPhase.CIRCLE;
   @Nullable
   Mob owner;
	...
	public DemonEye(EntityType<? extends DemonEye> p_21368_, Level p_21369_) {
		...
		this.xpReward = 7;
		this.moveControl = new DemonEye.EyeMoveControl(this);
	    this.lookControl = new DemonEye.EyeLookControl(this);
	}
	...
	protected BodyRotationControl createBodyControl() {
	      return new DemonEye.EyeBodyRotationControl(this);
	   }
	...
	class EyeAttackStrategyGoal extends Goal {
		...
		public void start() {
			...
			DemonEye.this.attackPhase = DemonEye.AttackPhase.CIRCLE;
		...
		public void tick() {
			if (DemonEye.this.attackPhase == DemonEye.AttackPhase.CIRCLE) {
				--this.nextSweepTick;
				if (this.nextSweepTick <= 0) {
					DemonEye.this.attackPhase = DemonEye.AttackPhase.SWOOP;
					this.setAnchorAboveTarget();
	...
	class EyeCircleAroundAnchorGoal extends DemonEye.EyeMoveTargetGoal {
		private float angle;
		...
		public boolean canUse() {
			return DemonEye.this.getTarget() == null || DemonEye.this.attackPhase == DemonEye.AttackPhase.CIRCLE;
		}
	...
	class EyeSweepAttackGoal extends DemonEye.EyeMoveTargetGoal {
